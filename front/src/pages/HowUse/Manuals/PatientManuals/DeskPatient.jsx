    ...
    return(
        ...
        <article>
            ...
            <p>
                ...
                cabezero y da clic en el texto "Inicia sesión", támbien puedes hacerlo dando clic en el mismo texto ubicado en la parte inferior de la foto de cada 
                uno de los psicólogos.
            </p>

            <p>
                Al dar clic, serás dirigido a nuestro formulario para iniciar sesión. Si ya tienes una cuenta creada, coloca correctamente tu correo y contraseña para 
                iniciar sesión.
            </p>
            ...
            <p>Una vez seas registrado seras dirigido al formulario para iniciar sesión (solo si tu te registraste, sino, da clic de nuevo en el texto "Inicia sesión"
                del cabezero o debajo de la foto de cualquier psicólogo). Llénalo con los datos previemente dados y da clic en el botón "Iniciar sesión".
            </p>
        ...
        <article>
            ...
            <p>
                En el cabezero veras un nuevo texto llamado "Mi psicólogo". Da clic en este texto. Seras dirigido a la agenda de tu psicólogo. En el calendario selecciona el día 
            ...
            <p>
                En este apartado de "Mi psicólogo", en la parte superior del calendario y de las horas disponibles, veras un texto donde se indica la fecha de tu siguiente
                sesión.
            </p>
        </article>
